...
export default function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 bg-white shadow-lg">
      {/* Use full-bleed container with no left/right padding on large screens */}
      <div className="flex items-center justify-between w-full max-w-screen-xl mx-auto px-0 py-4">
        {/* Logo + Brand: flush left on lg, small indent on mobile */}
